    ...
    <>
      <Grid className="wrapper" container justify="center" alignItems="center">
        ...
        <Grid className="wrapper__main">
          ...
          <Typography className="text2" variant="h5">
            {userProfile.email}
          </Typography>
        </Grid>
        <RadioButtonUncheckedIcon
          style={{ height: 50, width: 50, color: "#BE1E2D" }}
        />
        <Grid
          container
        ...
        <div className="toggle-section">
          {photoToShow.length < userPhotos.length && (
            <div
              aria-hidden="true"
              className="toggle-section toggle-section__more"
              onClick={handleShowMore}
            >
              <Typography
                className="toggle-section__text"
                variant="caption"
                color="primary"
              >
                More
              ...
              <ArrowDropDownIcon
                className="toggle-section__icon"
                color="primary"
              ></ArrowDropDownIcon>
            </div>
          )}
          {photoToShow.length > defaultNumberToRender && (
            <div
              aria-hidden="true"
              className="toggle-section toggle-section__collapse"
