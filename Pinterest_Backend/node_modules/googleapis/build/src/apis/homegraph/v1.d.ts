...
export declare namespace homegraph_v1 {
    ...
    export class Resource$Devices {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        requestLink(params: Params$Resource$Devices$Requestlink, options: StreamMethodOptions): GaxiosPromise<Readable>;
        requestLink(params?: Params$Resource$Devices$Requestlink, options?: MethodOptions): GaxiosPromise<Schema$Empty>;
        requestLink(params: Params$Resource$Devices$Requestlink, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        requestLink(params: Params$Resource$Devices$Requestlink, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        requestLink(params: Params$Resource$Devices$Requestlink, callback: BodyResponseCallback<Schema$Empty>): void;
    ...
    export interface Params$Resource$Devices$Requestlink extends StandardParameters {
        /**
         * Request body metadata
         */
